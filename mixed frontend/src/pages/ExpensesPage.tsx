...
export default function ExpensesPage({ data, setData, currentUser }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="fixed inset-0 z-[60] h-[100dvh] flex flex-col bg-slate-900">
          <div className="p-4 border-b border-slate-800 flex-shrink-0">
            <h3 className="text-lg font-semibold text-white">New Expense Entry</h3>
          </div>
          ...
          <div className="p-4 border-t border-slate-800 flex justify-end gap-3 flex-shrink-0 bg-slate-900">
            <button
